...
public class ChildrenSum {
    ...
    public static int childrenSumBrute(TreeNode root) {
        ...
        // Default is failure case since jo bhi satisfying nodes honge vo at last leaf nodes wali condition ko satisfy kr jayegne
        // this will execute jb dono mein se koi ek bhi 1 nhi hoga ie jb bhi ye sum wali condition fail ho jayegi
    }
}
